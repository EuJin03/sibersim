        ...
        <View style={styles.container}>
          ...
          <View style={styles.avatarContainer}>
            <Avatar.Image
              ...
              source={{
                uri: 'https://firebasestorage.googleapis.com/v0/b/sibersim-2a3c3.appspot.com/o/scam-virus-spyware-malware-antivirus-concept.jpg?alt=media&token=0d3e9807-0d43-4b59-bf7f-74cd12650ea7',
              }}
            />
            <IconButton
              icon="pencil"
